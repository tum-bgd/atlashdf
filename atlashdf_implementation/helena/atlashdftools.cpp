...
class ChunkedStringTable
{
    ...
    ChunkedStringTable(const std::string filename, const std::string dsetname, const std::vector<size_t>& dims, const std::vector<size_t>& maxdims, bool truncate=true)
    {
